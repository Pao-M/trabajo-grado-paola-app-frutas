...
class ProductListByComercianteScreen extends StatelessWidget {
  final String comercianteId;
  final String comercianteNombre;

  const ProductListByComercianteScreen({
    super.key,
    required this.comercianteId,
    required this.comercianteNombre,
  });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('🍎 Productos de $comercianteNombre'),
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where('id_comerciante', isEqualTo: comercianteId)
              .snapshots(),
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Este comerciante no tiene productos',
                      style: TextStyle(
                        fontSize: 18,
